  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="./">MultiGestor<sup><small><span class="label label-info">v1.0</span></small></sup> </a>
      </div>
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        ...
        ?>
          ...
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="index.php?view=rent"><i class="fa fa-cube"></i> Arriendo</a></li>
            <li><a href="index.php?view=rents"><i class="fa fa-th-large"></i> Arriendos</a></li>
            <li><a href="index.php?view=books"><i class="fa fa-male"></i> Sucu</a></li>
            <li><a href="index.php?view=editorials"><i class="fa fa-book"></i> Sucursales</a></li>

            <li><a href="index.php?view=clients"><i class="fa fa-male"></i> Clientes</a></li>
            <li><a href="index.php?view=authors"><i class="fa fa-th-list"></i> Mantencion</a></li>
            <?php if ($u->is_admin) : ?>

              <li><a href="index.php?view=users"><i class="fa fa-users"></i> Usuarios </a></li>
              <li><a href="index.php?view=reports"><i class="fa fa-th-list"></i> Reportes</a></li>
            <?php endif; ?>
          </ul>
