...
<div class="btn-group pull-right">
	<a href="index.php?view=newcamara&book_id=<?php echo $book->id; ?>" class="btn btn-default"><i class='fa fa-th-list'></i> Nuevo Camara</a>
</div>
		<h1><?php echo $book->title;?> <small>Camara</small></h1>
<br>
		<?php
